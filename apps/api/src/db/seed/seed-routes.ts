...
const ROUTES: Route[] = [
  ...
  { route_key: 'treasure-list', method: 'GET', path: '/treasure/hunts', use_case: 'listTreasureHunts', auth: 'session', req: null, res: null },
  { route_key: 'learning-list', method: 'GET', path: '/learning/routes', use_case: 'listLearning', auth: 'session', req: null, res: null },
  { route_key: 'leaderboard-list', method: 'GET', path: '/ranking', use_case: 'listLeaderboard', auth: 'session', req: null, res: null },
  { route_key: 'public-ad-decision', method: 'GET', path: '/ads/decision', use_case: 'publicAd', auth: 'public', req: null, res: 'publicAdResponse' },
  { route_key: 'content-list', method: 'GET', path: '/content', use_case: 'publishedContent', auth: 'public', req: null, res: 'publishedContentResponse' },
  { route_key: 'content-get', method: 'GET', path: '/content/:slug', use_case: 'contentBySlug', auth: 'public', req: null, res: 'publishedContentEntryResponse' },
  { route_key: 'admin-content', method: 'GET', path: '/admin/content', use_case: 'adminContent', auth: 'api_key', req: null, res: 'publishedContentResponse' },
  { route_key: 'admin-content-publish', method: 'POST', path: '/admin/content', use_case: 'adminContentPublish', auth: 'api_key', req: 'contentPublishRequest', res: 'publishedContentEntryResponse' },
