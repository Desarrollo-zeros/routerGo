...
- Remaining product and operational gaps are explicit in `tasks.md`: advertiser flows (T054), challenge/battle completion (T065, T081, T083-T084), and staged beta operations (T105). Rev.7 is not declared complete.
