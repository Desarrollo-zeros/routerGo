...
|---|---|---|---|
| P0-001 | The production composition is only partially real. | T034 now wires non-streaming chat completions through quote/reserve/provider/settle-or-release and rejects missing API-key context with 401. T035/T036 still own streaming and complete transport authorization/error contracts. | The supported completion path is executable behind the remaining API-key transport boundary; broader public rollout remains gated. |
